...
public class BVSTree<E extends Comparable<E> & Clonable>  implements Clonable {
    ...
    private BVSNode<E> delete(E k, BVSNode<E> t ) {
      ...
      else if( t.left != null && t.right != null ) {	// je to on, a m� oboch synov
          t.key = findMin(t.right).key;	// n�jdi min.prav�ho podstromu
          t.right = delete(t.key, t.right);	// rekurz.zma� minimum
      } else					// prav�ho podstromu
          t = (t.left != null) ? t.left : t.right;	// ak nem� 2 synov, je to �ahk�
      return t;
    }
